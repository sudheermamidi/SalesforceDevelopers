# Service Cloud Live Exercises and Advanced Topics
...
### Live Example Exercise 1: A contact center has SLA breaches because urgent cases sit in the wrong queue for more than two hours.

**Business Goal**

Build or troubleshoot a realistic Salesforce solution for this scenario. The focus is case management, entitlements, milestones, knowledge, Omni-Channel, contact-center productivity.

**Expected Architecture**

- Core objects/components: Case, Entitlement, Milestone, Knowledge, Contact, Account, Queue, User
...
1. What trade-offs would you make when designing Service Cloud for enterprise scale?
...
### Live Example Exercise 2: A support team wants Knowledge suggestions, macros, and case summaries embedded in the service console.
...
### Live Example Exercise 3: A global support org must route cases by product, language, customer tier, and agent capacity.
